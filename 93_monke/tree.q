...
DISCO
------------------------------------------------
* multiple trees can be used for reconstruction
================================================
...
- it allows the most efficiency when the processing method is depth-first. 

Alternate (equivalent, but more succinct?) definitions of "balanced" tree?
- height of the left and right sides dont differ more than one. 

Is a perfect tree complete? 
- since the last level is complete, yes
...
C'EST POSSIBLE?
------------------------------------------------
should be possible, but maybe knowing what type of tree we're given would help.
================================================